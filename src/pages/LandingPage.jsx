...
export default function VaqoLanding({ onApply, onLogin }) {
  ...
  const savedHours =
    Math.round(
      ((calc.clients * calc.bookings * 0.5 + calc.admin * 60) / 60) * 10,
    ) / 10;
  ...
  useEffect(() => {
    ...
    const anim = (k, target, ms) => {
      ...
      const tick = () => {
        ...
        setCount((c) => ({
          ...c,
          [k]: Math.round((1 - Math.pow(1 - p, 3)) * target),
        }));
    ...
    >
      ...
      <nav
        style={{
          ...
          background:
            scrolled || menuOpen ? "rgba(255,255,255,.97)" : "transparent",
      ...
      >
        ...
        {!isMobile && (
          <div style={{ display: "flex", alignItems: "center", gap: 2 }}>
              ...
              >
                ...
                <span
                  style={{
                    fontSize: 10,
                    transition: "transform .2s",
                    transform: featOpen ? "rotate(180deg)" : "none",
                    display: "inline-block",
                  }}
                >
                  ▾
            ...
            {/* Language switcher */}
            <button
              onClick={() => setLanguage(lang === "sq" ? "en" : "sq")}
              style={{
                ...btn("none", "#52525b"),
                padding: "6px 12px",
                fontSize: 12,
      ...
      <section
        style={{
          minHeight: "100vh",
          padding: `${isMobile ? 100 : 120}px ${px}px ${isMobile ? 48 : 80}px`,
          background: "#fafafa",
          position: "relative",
          overflow: "hidden",
          display: "flex",
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(ellipse 60% 60% at 80% 50%,rgba(124,58,237,.06) 0%,transparent 70%)",
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            ...
            >
              ...
              <h1
                style={{
                  fontSize: isMobile ? 38 : isTablet ? 52 : 76,
                  lineHeight: 1.0,
                  fontWeight: 900,
                  letterSpacing: "-.04em",
              ...
              <p
                style={{
                  ...
                  fontFamily: "system-ui",
                  margin: isMobile ? "0 auto 24px" : "0 0 36px",
                }}
              >
                {T.hero.desc}
              </p>
              ...
              >
                <button
                  ...
                  style={{
                    ...btn(),
                    padding: `${isMobile ? 12 : 13}px ${isMobile ? 22 : 28}px`,
                ...
                <button
                  ...
                  style={{
                    ...
                    padding: `${isMobile ? 12 : 13}px ${isMobile ? 18 : 22}px`,
                    borderRadius: 10,
              ...
              >
                ...
                >
                  ...
                  <div style={{ padding: 16 }}>
                    ...
                    >
                      {[
                        ["🚪", "47", lang === "sq" ? "Hyrje" : "Check-ins"],
                        ["💰", "385K", lang === "sq" ? "Ardhura" : "Revenue"],
                        ["📅", "12", lang === "sq" ? "Rezervime" : "Bookings"],
                      ].map(([ico, v, l]) => (
                        <div
                          key={l}
                          style={{
                    ...
                    {[
                      ["MH", "Mira H.", "Yoga", "#7c3aed"],
                      [
                        "AK",
                        "Ardit K.",
                        lang === "sq" ? "Prerje" : "Haircut",
                        "#18181b",
                      ],
                      [
                        "EJ",
                        "Era J.",
                        lang === "sq" ? "Masazh" : "Massage",
                        "#be185d",
                      ],
                    ].map(([ini, nm, svc, c]) => (
                      <div
                ...
                >
                  <div
                    style={{ fontSize: 9, fontWeight: 700, color: "#16a34a" }}
                  >
                    ✅ {lang === "sq" ? "Rezervim i Ri" : "New Booking"}
                  </div>
                  <div style={{ fontSize: 11, fontWeight: 600 }}>
                    Arta K. — Yoga
                  </div>
      ...
      >
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          ...
          >
            <div
              style={{
                width: isMobile || isTablet ? "100%" : 260,
                marginBottom: isMobile || isTablet ? 28 : 0,
              }}
            >
              <div
                style={{
                ...
                {T.categories.groups.map((cat, i) => (
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: "inherit",
                      transition: "all .15s",
                      background: activeCat === i ? "#18181b" : "#f4f4f5",
                      color: activeCat === i ? "#fff" : "#52525b",
                      fontSize: 13,
                      fontWeight: 600,
                    }}
                  >
      ...
      >
        <div style={{ maxWidth: 1060, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 36 }}>
            ...
            <h2
              style={{
                fontSize: isMobile ? 24 : isTablet ? 30 : 44,
                fontWeight: 900,
                lineHeight: 1.1,
                marginBottom: 10,
              }}
            ...
            {T.features.groups.map((f, i) => (
              <button
                ...
                style={{
                  ...
                  alignItems: "center",
                  gap: 6,
                  padding: `${isMobile ? 8 : 9}px ${isMobile ? 14 : 18}px`,
                  borderRadius: 100,
                  border: "none",
                  cursor: "pointer",
                  ...
                  fontFamily: "inherit",
                  transition: "all .2s",
                  background: activeFeat === i ? f.color : "#fff",
                  color: activeFeat === i ? "#fff" : "#52525b",
                  boxShadow:
                    activeFeat === i
              ...
              >
                <div
                  style={{
                    ...
                    height: 44,
                    borderRadius: 11,
                    background: T.features.groups[activeFeat].bg,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    fontSize: 20,
      ...
      >
        <div style={{ maxWidth: 1060, margin: "0 auto", textAlign: "center" }}>
          ...
          <button
            ...
            style={{
              ...btn("#c8a96e"),
              padding: `${isMobile ? 12 : 13}px ${isMobile ? 28 : 36}px`,
              fontSize: isMobile ? 14 : 15,
            }}
          >
            {T.howItWorks.cta}
              ...
              >
                {[
                  ...
                  <div key={s.k}>
                    ...
                    >
                      <label style={{ fontSize: 13, color: "#71717a" }}>
                        {s.label}
                      </label>
                      <span
                        style={{
              ...
              >
                ...
                >
                  ...
                  <strong style={{ color: "#c8a96e" }}>
                    7,900 L/{lang === "sq" ? "muaj" : "month"}
                  </strong>
                  <br />
                  {T.calc.roi}{" "}
                  <strong style={{ color: "#4ade80" }}>
                    {Math.max(0, savedMoney - 7900).toLocaleString(
                      lang === "sq" ? "sq-AL" : "en-US",
                    )}{" "}
                    L/{lang === "sq" ? "muaj" : "month"}
                  </strong>
                </div>
              </div>
            </div>
            ...
            style={{
              ...
              gridTemplateColumns: isMobile
                ...
                : isTablet
                  ...
                  : "repeat(3,1fr)",
              gap: 18,
              maxWidth: isMobile ? 400 : isTablet ? 600 : "100%",
              margin: "0 auto",
            }}
          >
            {T.pricing.plans.map((p, i) => (
              <div
                ...
                style={{
                  ...
                  border: `2px solid ${p.featured ? "#7c3aed" : "#e4e4e7"}`,
              ...
              >
                ...
                <div
                  style={{
                    display: "inline-flex",
                    background: p.featured ? "rgba(255,255,255,.1)" : "#f4f4f5",
                    borderRadius: 100,
                    padding: "2px 10px",
                    fontSize: 11,
                    fontWeight: 600,
                ...
                <div
                  style={{
                    ...
                    textTransform: "uppercase",
                    letterSpacing: ".08em",
                    color: p.featured ? "rgba(255,255,255,.4)" : "#a1a1aa",
                    marginBottom: 6,
                    fontFamily: "system-ui",
                  }}
                >
                ...
                <div
                  style={{
                    fontSize: 11,
                    color: p.featured ? "rgba(255,255,255,.35)" : "#71717a",
                    marginBottom: 20,
                    fontFamily: "system-ui",
                  }}
                >
                  {T.pricing.perMonth} · {p.desc}
                </div>
                <ul
                  style={{
                    listStyle: "none",
                  ...
                  {p.features.map((f, j) => (
                    <li
                      ...
                      style={{
                        fontSize: 13,
                        padding: "7px 0",
                        borderBottom: `1px solid ${p.featured ? "rgba(255,255,255,.07)" : "rgba(0,0,0,.05)"}`,
                        display: "flex",
                        alignItems: "center",
                        gap: 9,
                        fontFamily: "system-ui",
                ...
                <button
                  onClick={() =>
                    i === 2 ? go("tel:+3556922910410") : go("/demo")
                  }
                  style={{
                    display: "block",
                    width: "100%",
                    ...
                    cursor: "pointer",
                    fontFamily: "inherit",
                    border: p.featured ? "none" : "1.5px solid #e4e4e7",
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          >
            ...
            >
              {lang === "sq"
                ? "Pse bizneset zgjedhin Vaqo?"
                : "Why businesses choose Vaqo?"}
            </h2>
            <p
              style={{
            ...
            >
              {lang === "sq"
                ? "Ndërtuar enkas për tregun shqiptar."
                : "Built specifically for the Albanian market."}
            </p>
          </div>
          <div
            style={{
            ...
            {[
              {
                ...
                t:
                  lang === "sq"
                    ? "Setup brenda 24 orësh"
                    : "Setup within 24 hours",
                d:
                  lang === "sq"
                    ? "Filloni të punoni brenda 1 dite. Ne ju ndihmojmë me gjithçka."
                    : "Start operating within 1 day. We help you with everything.",
              },
              {
                ico: "🇦🇱",
                t:
                  lang === "sq"
                    ? "Gjithçka në Shqip"
                    : "Everything in Albanian",
                d:
                  lang === "sq"
                    ? "Platform, support dhe dokumentacion — tërësisht në gjuhën shqipe."
                    : "Platform, support and documentation — entirely in Albanian.",
              },
              {
                ico: "📞",
                t: lang === "sq" ? "Support Lokal" : "Local Support",
                d:
                  lang === "sq"
                    ? "Nuk flet me bot — flet me njerëz realë që e njohin tregun shqiptar."
                    : "No bots — talk with real people who know the Albanian market.",
              },
              {
                ico: "🔓",
                t: lang === "sq" ? "Pa Kontratë" : "No Contract",
                d:
                  lang === "sq"
                    ? "Anulo kurdo. Pa penalitete. Të dhënat janë gjithmonë tuajat."
                    : "Cancel anytime. No penalties. Your data is always yours.",
              },
              {
                ico: "📱",
                t:
                  lang === "sq"
                    ? "Rezervime Online 24/7"
                    : "Online Bookings 24/7",
                d:
                  lang === "sq"
                    ? "Klientët rezervojnë edhe kur ju jeni të mbyllur. Asnjë telefonatë e humbur."
                    : "Clients book even when you are closed. No missed calls.",
              },
              {
                ico: "📊",
                t: lang === "sq" ? "Raporte Automatike" : "Automatic Reports",
                d:
                  lang === "sq"
                    ? "Të ardhura, prezenca, klientë të riskut — të gjitha automatike."
                    : "Revenue, attendance, at-risk clients — all automated.",
              },
              {
                ico: "💬",
                t:
                ...
                d:
                  lang === "sq"
                    ? "Kujtesa para takimeve. Zero anulime të fundit të minutës."
                    : "Reminders before appointments. Zero last-minute cancellations.",
              },
              {
                ico: "💰",
                t: lang === "sq" ? "Faturim i Thjeshtë" : "Simple Billing",
                d:
                  lang === "sq"
                    ? "Regjistro pagesat, gjenero fatura dhe ngjit të ardhurat."
                    : "Record payments, generate invoices and track revenue.",
              },
              {
                ico: "🔒",
                t: lang === "sq" ? "Siguri & GDPR" : "Security & GDPR",
                d:
                  lang === "sq"
                    ? "Të dhënat e klientëve të mbrojtura me enkriptim dhe backup automatik."
                    : "Client data protected with encryption and automatic backup.",
              },
            ].map(({ ico, t, d }) => (
              <div
                key={t}
      ...
      >
        <div style={{ maxWidth: 560, margin: "0 auto" }}>
          ...
          <h2
            style={{
              fontSize: isMobile ? 26 : isTablet ? 32 : 52,
              fontWeight: 900,
              lineHeight: 1.05,
              letterSpacing: "-.03em",
              marginBottom: 16,
          ...
          >
            ...
            >
              <div style={{ fontSize: isMobile ? 32 : 36, marginBottom: 10 }}>
                🏢
              </div>
              <div style={{ fontSize: isMobile ? 16 : 18, marginBottom: 6 }}>
                {T.cta.forBusiness}
              </div>
              <div
                style={{
      ...
      <footer
        style={{
          background: "#1f2937",
          padding: `${isMobile ? 28 : 40}px ${px}px 24px`,
        }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          {/* Top footer */}
          ...
          >
            ...
            <div>
              ...
              >
                {lang === "sq"
                  ? "Platforma all-in-one për bizneset wellness në Shqipëri."
                  : "The all-in-one platform for wellness businesses in Albania."}
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                <a
                  href="tel:+355692291041"
                  style={{
                    color: "rgba(255,255,255,.5)",
                    fontSize: 13,
                    textDecoration: "none",
            ...
            <div>
              ...
              {[
                [lang === "sq" ? "Termat e Shërbimit" : "Terms", "/terms"],
                [lang === "sq" ? "Privatësia" : "Privacy", "/privacy"],
                ["GDPR", "/gdpr"],
              ].map(([l, h]) => (
                <a
                  key={l}
          ...
          >
            ...
            >
              {lang === "sq"
                ? "Ndërtuar me ❤️ në Shqipëri"
                : "Built with ❤️ in Albania"}
            </div>
          </div>
        </div>
      </footer>
