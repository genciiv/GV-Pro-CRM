...
const FAQS_GYM = [
  ...
  },
  {
    ...
    a: "Do të njoftoheni automatikisht. Mund të upgradoni planin kurdo pa humbur asnjë të dhënë.",
  },
  {
...
const FAQS_NUTR = [
  {
    q: "Sa fitoj si dietolog?",
    a: "Ti merr 70% nga çdo shitje. Nëse shet një dietë me 3,000L — ti merr 2,100L. Platforma merr 900L.",
  },
  {
    q: "Si i vendos çmimet?",
    a: "Ti vendos çmimin që dëshiron — nuk ka minimum apo maksimum. Platforma nuk ndërhyn.",
  },
  {
    q: "Kur marr pagesën?",
    a: "Pagesa bëhet cash te palestra. Pas çdo shitjeje konfirmohet dhe të ardhurat regjistrohen në panel.",
  },
  {
    q: "A duhet të kem shumë klientë?",
    a: "Jo. Fillon me 1 plan dhe e rrit me kohën. Platforma të jep akses te mijëra anëtarë palestrash.",
  },
  {
    q: "Çfarë duhet për të aplikuar?",
    a: "Emrin, emailin, telefoni, specializimin dhe një bio të shkurtër. Aprovimi bëhet brenda 24-48 orësh.",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Nga check-in me QR deri te fatura automatike — GV CRM i mban të
            ...
            >
              ...
              <div style={{ display: "flex" }}>
                ...
                <div style={{ flex: 1, padding: 10 }}>
                  ...
                  >
                    <div
                      style={{ fontSize: 8, fontWeight: 600, marginBottom: 5 }}
                    >
                      Të Ardhurat 2026
                    </div>
                    <div
                      ...
                      {[35, 48, 55, 62, 72, 85, 100, 90, 0, 0, 0, 0].map(
                        (h, i) => (
                          ...
                          >
                            ...
                            />
                            <div style={{ fontSize: 5, color: "#ccc" }}>
                              {"JFMAMJKGSTND"[i]}
                            </div>
                          </div>
                        ),
                  ...
                  >
                    <div
                      style={{ fontSize: 8, fontWeight: 600, marginBottom: 4 }}
                    >
                      Anëtarët Aktivë
                    </div>
                    {[
                      ...
                      >
                        ...
                        <div style={{ fontSize: 8, flex: 1, fontWeight: 500 }}>
                          {nm}
                        </div>
                        <div
                          style={{
      ...
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 60 }}>
            ...
            >
              Nga pronari te recepsioni — secili ka aksesin dhe funksionet që i
              duhen.
            </p>
          </div>
          <div
          ...
          >
            {[
              ...
              },
              {
                ...
                features: [
                  "QR Check-in i menjëhershëm",
                  "Shto anëtarë të rinj",
                  "Regjistro pagesa cash",
                  "Shih borxhet e klientëve",
                  "Printo fatura",
                ],
              },
              {
        ...
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ fontSize: 16, color: "#71717a", lineHeight: 1.7 }}>
              Llogarit sa orë dhe lekë kursen duke përdorur GV CRM.
            </p>
          </div>
          <div
            style={{
            ...
            >
              ...
              >
                {[
                  ...
                  {
                    k: "checkin",
                    label: "Kohë check-in manual (min/anëtar)",
                    min: 1,
                    max: 10,
                    step: 1,
                    unit: "min",
                  ...
                  {
                    k: "admin",
                    label: "Orë admin/ditë (pagesa, regjistrime)",
                    min: 1,
                    max: 8,
                    step: 1,
                    unit: "orë",
              ...
              >
                ...
                >
                  ...
                  >
                    {savedMoney.toLocaleString("sq-AL")}
                  </div>
                  <div
                    style={{
                      fontSize: 16,
                ...
                >
                  GV CRM kushton{" "}
                  <strong style={{ color: "#c8a96e" }}>7,900 L/muaj</strong>
                  <br />
                  Kurseni{" "}
                  <strong style={{ color: "#16a34a" }}>
                    {Math.max(0, savedMoney - 7900).toLocaleString("sq-AL")} L
                  </strong>{" "}
                  neto çdo muaj
                </div>
              </div>
      ...
      <section
        id="nutritionists"
        className="sp"
        style={{ padding: "100px 60px", background: "#f0fdf4" }}
      >
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div
            style={{
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 300 }}>
              ...
              >
                Shes dietat tua te mijëra anëtarë të palestrëve. Ti vendos
                çmimin, ti vendos orarin — ne e menaxhojmë pjesën tjetër.
              </p>
              {/* Commission box */}
              <div
                style={{
              ...
              <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
                <button
                  className="btn-green"
                  onClick={() => (window.location.href = "/nutritionist/apply")}
                >
                  🥗 Apliko si Dietolog →
                </button>
                <button className="btn-out" onClick={onLogin}>
                  Hyr si Dietolog
                </button>
              </div>
            </div>
                ...
                {[
                  {
                    ico: "💰",
                    t: "Ti vendos çmimin",
                    d: "Nuk ka limit minimum ose maksimum",
                  },
                  {
                    ico: "📱",
                    t: "Panel i plotë",
                    d: "Shih porositë dhe të ardhurat live",
                  },
                  {
                    ico: "👥",
                    t: "Klientë të sigurt",
                    d: "Akses te anëtarët e palestrëve",
                  },
                  {
                    ico: "📊",
                    t: "Statistika live",
                    d: "Sa shitje, sa të ardhura çdo ditë",
                  },
                  {
                    ico: "🎯",
                    t: "Marketing falas",
                    d: "Promovohu te mijëra klientë",
                  },
                  {
                    ico: "⚡",
                    t: "Setup i shpejtë",
                    d: "Aprovim brenda 24-48 orësh",
                  },
                ].map((b, i) => (
                  <div
                    key={i}
            ...
            >
              {[
                [
                  "1",
                  "Apliko Online",
                  "Plotëso formularin me bio dhe specializimin tënd",
                ],
                [
                  "2",
                  "Aprovohu",
                  "Brenda 24-48h merr email me kredencialet e hyrjes",
                ],
            ...
            {[
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: "inherit",
                  transition: "all .2s",
                  background: faqType === k ? "#fff" : "transparent",
                  color: faqType === k ? "#18181b" : "#71717a",
                  boxShadow:
                    faqType === k ? "0 1px 4px rgba(0,0,0,.08)" : "none",
                }}
              >
                {l}
              </button>
        ...
        <div style={{ maxWidth: 680, margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              <div style={{ ...S.serif, fontSize: 20, marginBottom: 8 }}>
                Palestre
              </div>
              <div
                style={{
              ...
              >
                Aprovo aplikimin dhe fillo menjëherë
              </div>
              <button
                className="btn-main"
                style={{
            ...
            >
              ...
              >
                Fillo të shesësh dietat tua sot
              </div>
              <button
                className="btn-green"
                style={{ width: "100%" }}
          ...
          >
            ✅ Aprovim brenda 24 orësh &nbsp;•&nbsp; 🔒 Pa kontratë afatgjatë
            &nbsp;•&nbsp; 💵 Pagesa cash
          </div>
        </div>
      </section>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 12 }}>
            © 2026 GV CRM — Bërë me ❤️ për Shqipërinë 🇦🇱
          </div>
          <div
