              ...
              (staff||[]).map(s=>(
                <div key={s.id} style={{display:'flex',alignItems:'center',gap:14,padding:'14px 16px',borderRadius:12,border:`2px solid ${selStaff?.id===s.id?'var(--g900)':'var(--g200)'}`,background:selStaff?.id===s.id?'var(--g50)':'#fff',cursor:'pointer',transition:'all .15s'}}
                  ...
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:12,color:'var(--g500)',marginTop:2}}>{s.speciality||'Terapiste'}</div>
            ...
            <div key={s.id} className="card" style={{padding:20}}>
              <div style={{display:'flex',gap:14,alignItems:'flex-start',marginBottom:16}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:12,color:'var(--g500)',marginBottom:6}}>{s.speciality||'Terapiste'}</div>
...
const NAV = [
  ...
  {s:'Menaxhim', items:[{id:'staff',l:'Stafi / Terapistët',i:'💆'},{id:'services',l:'Shërbimet',i:'✂️'}]},
]
const TITLES = { dashboard:'Dashboard', 'new-appointment':'Rezervim i Ri', appointments:'Rezervimet', staff:'Stafi / Terapistët', services:'Shërbimet' }
