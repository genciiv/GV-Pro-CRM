              ...
              (staff||[]).map(s=>(
                <div key={s.id} style={{display:'flex',alignItems:'center',gap:14,padding:'14px 16px',borderRadius:12,border:`2px solid ${selStaff?.id===s.id?'var(--tx)':'var(--border)'}`,background:selStaff?.id===s.id?'var(--surface2)':'#fff',cursor:'pointer',transition:'all .15s'}}
                  ...
                  <div style={{flex:1}}>
                    ...
                    <div style={{fontSize:12,color:'var(--tx3)',marginTop:2}}>{s.speciality||'Berber'}</div>
            ...
            <div key={s.id} className="card" style={{padding:20}}>
              <div style={{display:'flex',gap:14,alignItems:'flex-start',marginBottom:16}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:12,color:'var(--tx3)',marginBottom:6}}>{s.speciality||'Berber'}</div>
...
const NAV = [
  ...
  {s:'Menaxhim', items:[{id:'staff',l:'Stafi / Berberët',i:'S'},{id:'services',l:'Sherbimet',i:'X'}]},
  {s:'Rritje', items:[{id:'analytics',l:'Analytics',i:'A'},{id:'affiliate',l:'Affiliate',i:'F'},{id:'reminders',l:'Kujtesat',i:'K'}]},
]
const TITLES = { dashboard:'Dashboard', 'new-appointment':'Rezervim i Ri', appointments:'Rezervimet', calendar:'Kalendari', analytics:'Analytics', reminders:'🔔 Kujtesat', affiliate:'Affiliate', members:'Klientet', payments:'Pagesat', staff:'Stafi / Berberët', services:'Sherbimet' }
