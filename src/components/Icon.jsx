...
// Ikona SVG profesionale — zëvendëson të gjitha emoji-t
...
const icons = {
  ...
  payments:     <><rect x="1" y="4" width="22" height="16" rx="2"/><path d="M1 10h22"/></>,
  ...
  services:     <><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3L14.5 4z"/><circle cx="12" cy="13" r="3"/></>,
  ...
  phone:        <><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.61 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.09 6.09l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></>,
  ...
  // Business types
  gym:          <><path d="M6.5 6.5a2 2 0 0 0 0 11M17.5 6.5a2 2 0 0 1 0 11"/><path d="M5.5 6.5h1M17.5 6.5h1"/><path d="M5.5 17.5h1M17.5 17.5h1"/><rect x="7" y="10" width="10" height="4" rx="1"/></>,
  scissors:     <><circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><line x1="20" y1="4" x2="8.12" y2="15.88"/><line x1="14.47" y1="14.48" x2="20" y2="20"/><line x1="8.12" y1="8.12" x2="12" y2="12"/></>,
  sparkles:     <><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></>,
  leaf:         <><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10z"/><path d="M2 21c0-3 1.85-5.36 5.08-6C9.5 14.52 12 13 13 12"/></>,
  yoga:         <><circle cx="12" cy="4" r="1"/><path d="m9 12 2-2 2 2 2-2"/><path d="M8 20c.55-1.73 1.5-3.28 2.72-4.55"/><path d="M16 20c-.55-1.73-1.5-3.28-2.72-4.55"/><path d="M7 7c-.4 1.5-.1 3.5 1 5"/><path d="M17 7c.4 1.5.1 3.5-1 5"/></>,
  // QR
  qr:           <><rect x="3" y="3" width="5" height="5" rx="1"/><rect x="16" y="3" width="5" height="5" rx="1"/><rect x="3" y="16" width="5" height="5" rx="1"/><rect x="4" y="4" width="3" height="3"/><rect x="17" y="4" width="3" height="3"/><rect x="4" y="17" width="3" height="3"/><path d="M21 16h-3a2 2 0 0 0-2 2v3"/><path d="M21 21v.01"/><path d="M12 7v3a2 2 0 0 1-2 2H7"/><path d="M3 12h.01"/><path d="M12 3h.01"/><path d="M12 16v.01"/><path d="M16 12h1"/><path d="M21 12v.01"/><path d="M12 21v-1"/></>,
  // Misc
  ...
  spa:          <><path d="M3 11l19-9-9 19-2-8-8-2z"/></>,
}

export function Icon({ name, size = 18, color, className = '', style = {} }) {
  const paths = icons[name]
  if (!paths) return <span style={{fontSize:size*.9,lineHeight:1}}>{name}</span>
  return (
    <svg
